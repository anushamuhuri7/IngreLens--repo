...
class User(Base):
    ...
    medicine_scans = relationship("MedicineScan", back_populates="user")
...
class HealthProfile(Base):
    ...
    gluten_allergy = Column(Boolean, default=False)
    nut_allergy = Column(Boolean, default=False)
